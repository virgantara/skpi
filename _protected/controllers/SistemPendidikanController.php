...
/**
 * SistemPendidikanController implements the CRUD actions for SimakUniv model.
 */
class SistemPendidikanController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search($this->request->queryParams, 'SISDIK');
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            $total = SimakUniv::find()->where(['kode'=>'SISDIK'])->count();
