            ...
            <div class="widget-box widget-color-blue2">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <?= $form->field($model, 'sk_penerimaan_path')->fileInput(['accept' => 'application/pdf', 'class' => 'form-control'])->label('Surat Keputusan / Surat Keterangan telah mengikuti Proyek di Desa') ?>
