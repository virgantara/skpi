        ...
        <div class="col-sm-12">
            ...
            <div class="widget-box widget-color-blue2">
                <div class="widget-header">
                    <h4 class="widget-title lighter smaller">Proyek Kemanusiaan</h4>
                </div>
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        ?>
                            <p style="color: red;">Current File (Surat Keputusan / Surat Keterangan telah mengikuti Program Kemanusiaan): <?= Html::a($file_name, ['download', 'id' => $model->id, 'file' => 'sk_penerimaan_path'], ['target' => '_blank']) ?></p>
                        <?php endif; ?>
