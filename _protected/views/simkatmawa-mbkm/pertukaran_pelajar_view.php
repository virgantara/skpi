                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?= DetailView::widget([
                                            ...
                                            'attributes' => [
                                                ...
                                                [
                                                    'attribute' => 'status_sks',
                                                    'value' => function ($model) {
                                                        return MyHelper::listStatusSks()[$model->status_sks];
                                                    }
                                                ],
                                            ],
                                        ]) ?>
                                        ...
                                        <?= DetailView::widget([
                                            ...
                                            'attributes' => [
                                                [
                                                    ...
                                                    'label' => 'SK Penerimaan Pertukaran Pelajar',
                                                    'format' => 'raw',
                                                    'value' => function ($model) {
                                                ...
                                                [
                                                    ...
                                                    'label' => 'Surat Tugas / Surat Izin dari Fakultas',
                                                    'format' => 'raw',
                                                    'value' => function ($model) {
                                                ...
                                                [
                                                    'attribute' => 'rekomendasi_path',
                                                    'label' => 'Surat Rekomendasi dari PT Asal',
                                                    'format' => 'raw',
                                                    'value' => function ($model) {
                                                        if (empty($model->rekomendasi_path)) {
                                                            return '-';
                                                        }
                                                        return Html::a('Unduh <i class="fa fa-download"> </i>', ['download', 'id' => $model->id, 'file' => 'rekomendasi_path'], ['target' => '_blank', 'data-pjax' => 0]);
                                                    }
                                                ],
                                                [
                                                    'attribute' => 'khs_pt_path',
                                                    'label' => 'KHS dari PT Penerima',
                                                    'format' => 'raw',
                                                    'value' => function ($model) {
                                                        if (empty($model->khs_pt_path)) {
                                                            return '-';
                                                        }
                                                        return Html::a('Unduh <i class="fa fa-download"> </i>', ['download', 'id' => $model->id, 'file' => 'khs_pt_path'], ['target' => '_blank', 'data-pjax' => 0]);
                                                    }
                                                ],
                                                [
                                                    'attribute' => 'sertifikat_path',
                                                    'label' => 'Sertifikat Pertukaran Pelajar',
                                                    'format' => 'raw',
                                                    'value' => function ($model) {
