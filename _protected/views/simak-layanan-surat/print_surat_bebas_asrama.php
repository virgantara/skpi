...
<table border="0" style="font-size:9px;font-weight:bold;;font-family: 'Times'" width="100%">
      ...
      <tr>
        <td colspan="4" align="center">
          <strong style="font-size: 12px;"><u>SURAT KETERANGAN BEBAS ASRAMA</u></strong>
          <br>
 ...
 <br><br>
    <table border="0" width="100%" style="font-family: 'Times';font-size: 12px;;text-indent: 35px">
      <tr>
        ...
        <tr>
           <td align="left"  style="font-weight: bold;"> Asrama</td>
           <td align="center" >:</td>
           <td align="left" ><?=(!empty($mhs->kamar) ? $mhs->kamar->asrama->nama : '-')?></td>
         </tr>
         <tr>
           <td align="left"  style="font-weight: bold;"> Kamar</td>
           <td align="center" >:</td>
           <td align="left" ><?=(!empty($mhs->kamar) ? $mhs->kamar->nama : '-')?></td>
         </tr>
        </table>
        </td>
