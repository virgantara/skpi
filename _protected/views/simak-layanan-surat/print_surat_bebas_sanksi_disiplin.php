...
<table border="0" style="font-size:9px;font-weight:bold;;font-family: 'Times'" width="100%">
      ...
      <tr>
        <td colspan="4" align="center">
          <strong style="font-size: 12px;"><u>SURAT KETERANGAN BEBAS SANKSI</u></strong>
          <br>
...
<table border="0" width="100%" style="font-family: 'Times';font-size: 12px;;">
      <tr>
        <td width="100%" style="text-align: justify;">
          <p style=""><b>Berakhlak Baik dan Terbebas dari Segala Sanksi Disiplin</b> di Universitas Darussalam Gontor pada Tahun Ajaran <?=$thn->nama_tahun?>.
            <br>Demikian surat ini kami buat agar dapat menjadi maklum adanya dan dapat dipergunakan sebagaimana mestinya.</p>
