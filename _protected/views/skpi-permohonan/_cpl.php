...
<table cellpadding="2" border="0" cellspacing="0" width="100%">
  <tr>
    <td width="49%" style=";background-color:#b8b8b8">A. CAPAIAN PEMBELAJARAN</td>
    <td width="2%"></td>
    <td width="49%" style=";background-color:#b8b8b8"><i>A. LEARNING OUTCOMES</i></td>
  </tr>
  <?php 
  foreach($list_cpl as $q=>$item){
   ?>
  <tr>
    <td style="text-align: justify;"><?=$q+1?>. <?=$item->deskripsi?></td>
    <td></td>
    <td style="text-align: justify;;color:#176da7"><i><?=$q+1?>. <?=$item->deskripsi_en?></i></td>
  </tr>
