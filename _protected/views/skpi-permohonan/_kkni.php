...
<table cellpadding="2" border="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td style="text-align: justify;border:1px solid #7c7d7e"><?=$counter?>. <?=$item->nama?></td>
    <td></td>
