...
<table cellpadding="2" border="0" cellspacing="0" width="100%">
  <tr>
    <td width="49%" style=";background-color:#b8b8b8">SISTEM PENDIDIKAN</td>
    <td width="2%"></td>
    <td width="49%" style=";background-color:#b8b8b8"><i>EDUCATION SYSTEM</i></td>
  </tr>
  <?php 
  foreach($list_sistem_pendidikan as $q=>$item){
   ?>
  <tr>
    <td style="text-align: justify;"><?=$q+1?>. <?=$item->nama?></td>
    <td></td>
    <td style="text-align: justify;;font-style: italic;color:#176da7"><?=$q+1?>. <?=$item->nama_en?></td>
  </tr>
