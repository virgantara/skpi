...
/* @var $searchModel app\models\SimakTesSearch */
...
$jenis_tes_tags = (!empty($_GET['jenis_tes']) ? $_GET['jenis_tes'] : null);
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?= $form->field($searchModel, 'jenis_tes')->widget(Select2::classname(), [
                                        'data' => $list_jenis_tes,
                                        'value' => $jenis_tes_tags,
                                        'options' => [
