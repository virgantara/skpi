...
class SimakMagangSearch extends SimakMagang
{
    ...
    {
        return [
            [['id', 'nim', 'nama_instansi', 'alamat_instansi', 'telp_instansi', 'email_instansi', 'nama_pembina_instansi', 'jabatan_pembina_instansi', 'kota_instansi', 'is_dalam_negeri', 'tanggal_mulai_magang', 'tanggal_selesai_magang', 'status_magang_id','jenis_magang_id', 'keterangan','pembimbing_id','nama_dosen','nama_prodi','kode_prodi'], 'safe'],
        ];
    }
