 ...
 * @property SimakJurnal[] $simakJurnals
 ...
 * @property SimakMatakuliahRumpun[] $simakMatakuliahRumpuns
 * @property SimakProposalSkripsiPenilaian[] $simakProposalSkripsiPenilaians
 ...
 * @property SimakRps[] $simakRps
 * @property SimakRps[] $simakRps0
 * @property SimakRps[] $simakRps1
 * @property SimakSkripsiPenilaian[] $simakSkripsiPenilaians
...
class Dosen extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(ErpOrganisasiMahasiswa::class, ['pembimbing_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Events::class, ['dosen_id' => 'nidn']);
    }
    ...
    {
        return $this->hasMany(InputSoal::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakJadwal::class, ['id' => 'jadwal_id'])->viaTable('simak_ajar_dosen', ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabAdministrasiPenelitian::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabAdministrasiPengabdian::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(LitabBorangMonevLaporanKemajuanPenelitian::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabBorangNilaiPenelitian::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabBorangNilaiPengabdian::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabBukuDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabHkiDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabJurnalDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabLuaranLainDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPemakalahDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['reviewer1_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['reviewer2_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['anggota1_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['anggota2_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['anggota3_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['reviewer1_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['reviewer2_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['anggota1_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['anggota2_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['anggota3_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabReviewAbdimas::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabReview::class, ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakMatakuliah::class, ['id' => 'mk_id'])->viaTable('simak_matakuliah_rumpun', ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Notification::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPenelitian::class, ['id' => 'penelitian_id'])->viaTable('litab_review', ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(LitabPengabdian::class, ['id' => 'pengabdian_id'])->viaTable('litab_review_abdimas', ['reviewer_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakAjarDosen::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakDosenPembimbing::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakDosenPenguji::class, ['dosen_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakJadwalPengajar::class, ['dosen_id' => 'id']);
    }

    /**
     * Gets query for [[SimakJurnals]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakJurnals()
    {
        return $this->hasMany(SimakJurnal::class, ['dosen_pengampu_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakMasterfakultas::class, ['pejabat' => 'nidn']);
    }
    ...
    {
        return $this->hasMany(SimakMastermahasiswa::class, ['nip_co_promotor1' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakMastermahasiswa::class, ['nip_co_promotor2' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakMastermahasiswa::class, ['nip_promotor' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakMasterprogramstudi::class, ['nidn_ketua_prodi' => 'nidn']);
    }

    /**
     * Gets query for [[SimakMatakuliahRumpuns]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakMatakuliahRumpuns()
    {
        return $this->hasMany(SimakMatakuliahRumpun::class, ['dosen_id' => 'id']);
    }

    /**
     * Gets query for [[SimakProposalSkripsiPenilaians]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakProposalSkripsiPenilaians()
    {
        return $this->hasMany(SimakProposalSkripsiPenilaian::class, ['penguji_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakProposalSkripsi::class, ['penguji1' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakProposalSkripsi::class, ['penguji2' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakProposalSkripsi::class, ['penguji3' => 'id']);
    }

    /**
     * Gets query for [[SimakRps]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakRps()
    {
        return $this->hasMany(SimakRps::class, ['dosen_pengembang_id' => 'id']);
    }

    /**
     * Gets query for [[SimakRps0]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakRps0()
    {
        return $this->hasMany(SimakRps::class, ['koordinator_id' => 'id']);
    }

    /**
     * Gets query for [[SimakRps1]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakRps1()
    {
        return $this->hasMany(SimakRps::class, ['kaprodi_id' => 'id']);
    }

    /**
     * Gets query for [[SimakSkripsiPenilaians]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSimakSkripsiPenilaians()
    {
        return $this->hasMany(SimakSkripsiPenilaian::class, ['penguji_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakSkripsi::class, ['penguji1' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakSkripsi::class, ['penguji2' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakSkripsi::class, ['penguji3' => 'id']);
    }
    ...
    {
        return $this->hasMany(SimakUniversitas::class, ['rektor' => 'id']);
    }
}
