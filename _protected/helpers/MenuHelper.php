...
class MenuHelper
{
    public static function getMenuItems()
    {
	    ...
	    if (Yii::$app->user->can('operatorCabang')||Yii::$app->user->can('asesor')|| Yii::$app->user->can('akpam')|| Yii::$app->user->can('operatorUnit'))
	    {
		    ...
		    $menuItems[] = ['label' => '<i class="menu-icon fa fa-home"></i><span class="menu-text"> Organisasi/Kepanitiaan </span><i class="caret"></i>', 
		         'url' => '#',
		         'submenuTemplate' => "\n<ul class='submenu'>\n{items}\n</ul>\n",
		         'template' => '<a href="{url}" class="dropdown-toggle">{label}</a>',
		        'items'=>[
		...
		$menuItems[] = ['label' => '<i class="menu-icon fa fa-home"></i><span class="menu-text"> Auth </span><i class="caret"></i>', 
		         'url' => '#',
		         'submenuTemplate' => "\n<ul class='submenu'>\n{items}\n</ul>\n",
		         'template' => '<a href="{url}" class="dropdown-toggle">{label}</a>',
		         'visible' => Yii::$app->user->can('operatorCabang')||Yii::$app->user->can('asesor'), 
